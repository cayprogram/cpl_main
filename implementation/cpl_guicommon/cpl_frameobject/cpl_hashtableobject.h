#ifndef CPL_HASHTABLEOBJECT_H
#define CPL_HASHTABLEOBJECT_H
...
class cpl_ObjectHashTableStringOneKey {
...
public:
    ...
    //constructor
    cpl_ObjectHashTableStringOneKey(int tablesize = 1000) {
    ...
    //destructor
    virtual ~cpl_ObjectHashTableStringOneKey() {
        ObjectIdHashClean();
    }
...
inline ObjectIdHashIndexType cpl_ObjectHashTableStringOneKey::ObjectIdHashFunction(ObjectIdKeyType key) {
...
inline ObjectIdStatusEnum cpl_ObjectHashTableStringOneKey::ObjectIdInsert(ObjectIdKeyType key, ObjectIdRecType * rec) {
...
inline ObjectIdStatusEnum cpl_ObjectHashTableStringOneKey::ObjectIdDelete(ObjectIdKeyType key) {
...
inline ObjectIdStatusEnum cpl_ObjectHashTableStringOneKey::ObjectIdFind(ObjectIdKeyType key, ObjectIdRecType * rec) {
    ObjectIdNodeType * p;
...
inline ObjectIdStatusEnum cpl_ObjectHashTableStringOneKey::ObjectIdHashInit(int TableSize) {
    //@@preconditions
    assert(TableSize > 0);
    //@@end preconditions
...
inline ObjectIdStatusEnum cpl_ObjectHashTableStringOneKey::ObjectIdHashClean() {
    ObjectIdNodeType * p0, * p;
    int i = 0;
    for (i = 0; i < ObjectIdHashTableSize; i++) {
