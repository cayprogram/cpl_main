...
//-----------------------------------------------------------------------------
void cpl_Sort::QuickSort(int array[], int index_array[], int num_entry) {
    //@@preconditions
    assert(num_entry > 0);
    //@@end preconditions
...
//-----------------------------------------------------------------------------
void cpl_Sort::QuickSort(float array[], int index_array[], int num_entry) {
    //@@preconditions
    assert(num_entry > 0);
    //@@end preconditions
...
//-----------------------------------------------------------------------------
void cpl_Sort::FilterArray(float array[], int index_array[], int num_entry, int descend) {
    //@@preconditions
    assert(num_entry > 0);
    //@@end preconditions
...
//-----------------------------------------------------------------------------
void cpl_Sort::FilterArray(int array[], int index_array[], int num_entry, int descend) {
    //@@preconditions
    assert(num_entry > 0);
    //@@end preconditions
...
//-----------------------------------------------------------------------------
void cpl_Sort::ReverseArray(int array[], int num_entry) {
    //@@preconditions
    assert(num_entry > 0);
    //@@end preconditions
