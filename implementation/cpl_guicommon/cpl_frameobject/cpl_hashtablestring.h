#ifndef CPL_HASHTABLESTRING_H
#define CPL_HASHTABLESTRING_H
...
class cpl_HashTableStringOneKey {
...
public:
    ...
    //constructor
    cpl_HashTableStringOneKey(int tablesize = 1000) {
    ...
    //destructor
    virtual ~cpl_HashTableStringOneKey() {
        StringIdHashClean();
    }
...
inline StringIdHashIndexType cpl_HashTableStringOneKey::StringIdHashFunction(StringIdKeyType key) {
...
inline StringIdStatusEnum cpl_HashTableStringOneKey::StringIdInsert(StringIdKeyType key, StringIdRecType * rec) {
...
inline StringIdStatusEnum cpl_HashTableStringOneKey::StringIdDelete(StringIdKeyType key) {
...
inline StringIdStatusEnum cpl_HashTableStringOneKey::StringIdFind(StringIdKeyType key, StringIdRecType * rec) {
    StringIdNodeType * p;
...
inline StringIdStatusEnum cpl_HashTableStringOneKey::StringIdHashInit(int TableSize) {
    //@@preconditions
    assert(TableSize > 0);
    //@@end preconditions
...
inline StringIdStatusEnum cpl_HashTableStringOneKey::StringIdHashClean() {
    StringIdNodeType * p0, * p;
    int i = 0;
    for (i = 0; i < StringIdHashTableSize; i++) {
